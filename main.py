...
link = pd.read_csv('C://Users//eduar//Desktop//DEV//Football//MLS//links.csv')
...
data_inicio = datetime.strptime('2024-02-21', '%Y-%m-%d')
...
if dataframes:
    ...
    df_final.to_csv('C://Users//eduar//Desktop//DEV//Football//MLS//database_novo.csv', index=False)
else:
