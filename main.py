...
link = pd.read_csv(r'C:\Users\eduar\OneDrive\Desktop\DEV\Football\MLS\links.csv')
...
data_inicio = datetime.strptime('2024-10-14', '%Y-%m-%d')
...
if dataframes:
    ...
    df_final.to_csv(r'C:\Users\eduar\OneDrive\Desktop\DEV\Football\MLS\database_temp.csv', index=False)
else:
