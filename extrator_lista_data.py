...
link = pd.read_excel('C://Users//eduar//Desktop//DEV//Football//MLS//links.xlsx')
...
data_inicio = datetime.strptime('2024-09-07', '%Y-%m-%d')
...
if dataframes:
    ...
    df_final.to_excel('C://Users//eduar//Desktop//DEV//Football//MLS//database_temp.xlsx', index=False)
else:
